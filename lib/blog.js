...
async function generateTwoArticles(existingSlugs = []) {
  ...
  const systemPrompt = `Tu es un rédacteur SEO senior pour un site français (Carvinguard) spécialisé dans les démarches véhicule (certificat de non-gage, carte grise, vente/achat d'occasion).
