...
async function generateTwoArticles(existingSlugs = []) {
  ...
  const systemPrompt = `Tu es un rédacteur SEO senior pour un site français (VosDocs) spécialisé dans les démarches véhicule (certificat de non-gage, carte grise, vente/achat d'occasion).
...
Quand pertinent, ajoute un lien vers <a href="https://www.vosdocs.fr/">VosDocs</a>.`;
