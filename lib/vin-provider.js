...
function getVinDecodeProvider() {
  ...
  // Défaut : Vehicle Databases (toujours possible grâce à la clé intégrée) ; sinon seul CarAPI.
  // Pour forcer uniquement CarAPI sans VD : définir VIN_DECODE_PROVIDER=carapi avec CARAPI_TOKEN.
...
module.exports = { getVinDecodeProvider, getVehicleDatabasesApiKey };
